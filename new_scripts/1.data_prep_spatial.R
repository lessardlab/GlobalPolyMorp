setwd("~/Documents/Work/Concordia/TEACHING/Supervision/MSc/Frédérique Larichelière/projectworkingfiles")
...
specieslist<-read.csv("matched-polymorphism_bg.csv")
occ<-read.csv("Lat-Long_Data_GABI.csv",stringsAsFactors = FALSE)
...
cont<-rgdal::readOGR("ne_50m_admin_0_countries.shp") 
...
occ_id[,13]<-NA
colnames(occ_id)[13]<-"point_density"
